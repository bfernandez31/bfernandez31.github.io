...
- [x] No forced CONSERVATIVE fallbacks needed (PRAGMATIC used with high confidence)
...
- PRAGMATIC policy applied with high confidence (-5 score) due to explicit user directives
